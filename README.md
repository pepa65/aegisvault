...
```sh
wget https://github.com/pepa65/aegisvault/releases/download/0.3.73/aegisvault
...
## Usage
```text
aegisvault 0.3.73 - Convert otpauth URI file to Encrypted Aegis vault JSON on stdout
