...
* The codebase was initially imported from [the Gnome Authenticator project](https://gitlab.gnome.org/World/Authenticator/-/blob/0.3.31747ecfd73cff50cda574e7bdbebab183ba8/src/backup/aegis.rs).
...
```sh
wget https://github.com/pepa65/argisvault/releases/download/0.3.31/aegisvault
...
## Usage
```text
aegisvault 0.3.31 - Convert otpauth URI file to Encrypted Aegis vault JSON on stdout
