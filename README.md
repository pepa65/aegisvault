...
```sh
wget https://github.com/pepa65/argisvault/releases/download/0.2.8/aegisvault
...
## Usage
```text
aegisvault 0.2.8 - Convert otpauth URI file to Encrypted Aegis vault JSON on stdout
