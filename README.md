...
```sh
wget https://github.com/pepa65/argisvault/releases/download/0.3.53/aegisvault
...
## Usage
```text
aegisvault 0.3.53 - Convert otpauth URI file to Encrypted Aegis vault JSON on stdout
